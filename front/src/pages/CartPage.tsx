    ...
    <tr className="border-b border-gray-100 last:border-0">
      ...
      <td className="py-4 pr-4 text-center">
        <input
          ...
          className="w-16 border border-gray-300 rounded-xl px-2 py-1 text-sm text-center focus:outline-none focus:ring-2 focus:ring-[#1DA462] disabled:opacity-50"
        />
      </td>
      <td className="py-4 pr-4 text-sm font-semibold text-[#1DA462] text-right whitespace-nowrap">
...
export default function CartPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Tu cesta</h1>
        <p className="text-sm text-gray-500">Revisa tu selección antes de continuar</p>
      </div>
      ...
      {!cart || cart.items.length === 0 ? (
        <div className="text-center py-20 text-gray-400">
          ...
          <p className="text-sm mb-4">Tu cesta está vacía</p>
          <Link
            to="/catalog"
            className="inline-block bg-[#1DA462] hover:bg-[#178a52] text-white text-sm font-semibold px-6 py-2.5 rounded-full transition-colors"
          >
            Ver productos
          </Link>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="border-t border-gray-100 px-6 py-4 flex items-center justify-between">
            ...
            >
              {clearing ? 'Vaciando...' : 'Vaciar cesta'}
            </button>
